  ...
  return (
    <>
      <div className="relative">
        <Image src={"/image.png/Hero.png"} alt="Picture of the author"
         width={300}
         height={300}
         />
      ...
      <div className="text-center w-15 mt-3">
        ...
        <p>
          For More Informations About Our Product & Services. Please Feel Free To Drop Us<br /> An Email. Our Staff Always Be There To Help You Out. Do Not
          Hesitate!
        </p>
      </div>
